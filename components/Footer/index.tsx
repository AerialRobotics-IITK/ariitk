...
const socialIconGlow =
  "border-2 border-blue-400 rounded-full shadow-lg transition-all duration-300";
const socialIconStyle = {
  boxShadow: "0 0 0 4px #3b82f6, 0 0 18px 2px #60a5fa",
};
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start gap-y-12">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            {/* Team Photo with bluish tint, left-aligned */}
            <div className="mb-6">
              <div
                className="rounded-lg w-72 h-44 overflow-hidden border-4 border-blue-400"
                style={{
