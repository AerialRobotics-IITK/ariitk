...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-gray-200 pt-16 dark:bg-gray-600 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <h1 className="mb-12 text-xl font-bold text-black dark:text-white">
                    ARIITK
                  </h1>
                  {/* <Image
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  The team was formed with a vision to increase awareness and
                  promote the utility of UAVs. Since 2018, the team is working
                  to provide autonomous UAV based open-source solutions for
                  real-life problems.
                </p>
                ...
                <center>
                  <div className="map">
                    <iframe
                      ...
                      width="320"
                      height="250"
                      // style="border:0; border-radius: 1rem; margin:0 0 0 30px"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#29abe2" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#29abe2" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
